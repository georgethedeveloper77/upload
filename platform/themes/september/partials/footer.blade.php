    ...
    <div class="panel--search" id="site-search"><a class="panel__close" href="#"><i class="feather icon icon-x"></i></a>
        <div class="container">
            <form class="form--primary-search" action="{{ route('public.products') }}" method="GET">
                <input class="form-control" name="q" type="text" value="{{ request()->query('q') }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn--custom btn--outline btn--rounded btn--sm"
                            data-dismiss="modal">{{ __('Cancel') }}</button>
                    <button type="button"
                            class="btn--custom btn--rounded confirm-remove-item-cart btn--sm">{{ __('Yes, remove it!') }}</button>
                </div>
            </div>
        </div>
    </div>
