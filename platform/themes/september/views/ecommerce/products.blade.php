...
<main class="page--shop">
    <div class="page__hero bg--cover"
         data-background="{{ theme_option('product_page_banner_image') ? RvMedia::getImageUrl(theme_option('product_page_banner_image')) : Theme::asset()->url('img/bg/shop.jpg') }}">
                ...
                <div class="container">
                    <form action="{{ URL::current() }}" method="GET">
                        <div class="shop__header">
                            ...
                            <a class="panel-trigger btn--custom btn--rounded btn--outline"
                               href="#filter-product">{{ __('Filter Products') }}</a>
                        </div>
