...
(function (temp) {
    ...
    T.prototype = {
        ...
        save: function (name, template) {
            ...
            if (!this.templates.hasOwnProperty(ns)) {
                this.templates[ns] = {};
            }
        ...
        render: function (name, data, opts) {
            ...
            // params
            if (opts.preData) {
                opts.data = opts.preData.call(opts.scope, opts.data);
            }
            if (opts.pre) {
                ret = opts.pre.call(opts.scope, opts.data);
            }
            ...
            // use either the specified scope, or the default of null (set earlier)
            if (opts.post) {
                opts.post.call(opts.scope, new_el, opts.data);
            }
        ...
        checkRender: function (opts) {
            if (this.options.if_attr in opts && !opts[this.options.if_attr]) {
                return false;
            }
            return true;
        },
        ...
        _createEl: function (type) {
            if (type in el_cache && el_cache[type].cloneNode) {
        ...
        element: function (type, attributes, content) {
            ...
            if (attributes) {
                ...
                if (!this.checkRender(attributes)) {
                    el = null;
                    return "";
                }
        ...
        isSafeMode: function (_local_safe_mode) {
            if (typeof _local_safe_mode != "undefined") {
                return !!_local_safe_mode;
            }
            if (this.cur_options && "safe_mode" in this.cur_options) {
                return !!this.cur_options.safe_mode;
            }
        ...
        noConflict: function (new_name) {
            ...
            try {
                delete window[_last_name];
            } catch (ex) {
                window[_last_name] = undefined;
            }
