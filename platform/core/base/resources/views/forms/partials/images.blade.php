    ...
    <div class="images-wrapper">
        <div data-name="{{ $name }}"
            ...
            <p style="color:#c3cfd8">{{ trans('core/base::base.using_button') }}
                <strong>{{ trans('core/base::base.select_image') }}</strong> {{ trans('core/base::base.to_add_more_image') }}
                .</p>
        </div>
                    ...
                    @if (!empty($image))
                        <li class="gallery-image-item-handler">
                            ...
                            <div class="custom-image-box image-box">
                                ...
                                <div
                                    class="preview-image-wrapper @if (!Arr::get($attributes, 'allow_thumb', true)) preview-image-wrapper-not-allow-thumb @endif">
                                    <img
                                        src="{{ RvMedia::getImageUrl($image, Arr::get($attributes, 'allow_thumb', true) == true ? 'thumb' : null) }}"
...
@push('footer')
    <script id="gallery_select_image_template" type="text/x-custom-template">
        ...
        <div class="custom-image-box image-box">
            ...
            <img src="{{ RvMedia::getDefaultImage(false) }}" alt="{{ trans('core/base::base.preview_image') }}"
                 class="preview_image">
