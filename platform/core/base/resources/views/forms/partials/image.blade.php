<div class="image-box">
    ...
    <div
        ...
        <img
            src="{{ RvMedia::getImageUrl($value, Arr::get($attributes, 'allow_thumb', true) == true ? 'thumb' : null, false, RvMedia::getDefaultImage()) }}"
            alt="{{ trans('core/base::base.preview_image') }}" class="preview_image"
            @if (Arr::get($attributes, 'allow_thumb', true)) width="150" @endif>
