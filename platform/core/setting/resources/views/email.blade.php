                    ...
                    <div class="wrapper-content pd-all-20" id="email-config-form">
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="email_driver">{{ trans('core/setting::setting.email.mailer') }}</label>
                        ...
                        <div data-type="smtp"
                            ...
                            <div class="form-group">
                                <label class="text-title-field"
                                       for="email_port">{{ trans('core/setting::setting.email.port') }}</label>
                            ...
                            <div class="form-group">
                                <label class="text-title-field"
                                       for="email_host">{{ trans('core/setting::setting.email.host') }}</label>
                            ...
                            <div class="form-group">
                                <label class="text-title-field"
                                       for="email_username">{{ trans('core/setting::setting.email.username') }}</label>
                            ...
                            <div class="form-group">
                                <label class="text-title-field"
                                       for="email_password">{{ trans('core/setting::setting.email.password')  }}</label>
                            ...
                            <div class="form-group" style="margin-bottom: 1em;">
                                <label class="text-title-field"
                                       for="email_encryption">{{ trans('core/setting::setting.email.encryption') }}</label>
                        ...
                        <div data-type="mailgun"
                            ...
                            <div class="form-group">
                                <label class="text-title-field"
                                       for="email_mail_gun_domain">{{ trans('core/setting::setting.email.mail_gun_domain') }}</label>
                            ...
                            @if (!app()->environment('demo'))
                                <div class="form-group">
                                    <label class="text-title-field"
                                           for="email_mail_gun_secret">{{ trans('core/setting::setting.email.mail_gun_secret')  }}</label>
                            ...
                            <div class="form-group" style="margin-bottom: 1em;">
                                <label class="text-title-field"
                                       for="email_mail_gun_endpoint">{{ trans('core/setting::setting.email.mail_gun_endpoint') }}</label>
                        ...
                        <div data-type="ses"
                            ...
                            <div class="form-group">
                                <label class="text-title-field"
                                       for="email_ses_key">{{ trans('core/setting::setting.email.ses_key') }}</label>
                            ...
                            @if (!app()->environment('demo'))
                                <div class="form-group">
                                    <label class="text-title-field"
                                           for="email_ses_secret">{{ trans('core/setting::setting.email.ses_secret')  }}</label>
                            ...
                            <div class="form-group" style="margin-bottom: 1em;">
                                <label class="text-title-field"
                                       for="email_ses_region">{{ trans('core/setting::setting.email.ses_region') }}</label>
                        ...
                        <div data-type="postmark"
                            ...
                            @if (!app()->environment('demo'))
                                <div class="form-group">
                                    <label class="text-title-field"
                                           for="email_postmark_token">{{ trans('core/setting::setting.email.postmark_token')  }}</label>
                        ...
                        <div data-type="sendmail"
                            ...
                            <div class="form-group">
                                <label class="text-title-field"
                                       for="email_sendmail_path">{{ trans('core/setting::setting.email.sendmail_path')  }}</label>
                                ...
                                <span
                                    class="help-ts">{{ trans('core/setting::setting.email.default') }}: <code>{{ config('mail.mailers.sendmail.path') }}</code></span>
                            </div>
                        </div>
                        ...
                        <div data-type="log"
                            ...
                            <div class="form-group" style="margin-bottom: 1em;">
                                <label class="text-title-field"
                                       for="email_log_channel">{{ trans('core/setting::setting.email.log_channel') }}</label>
                                <input type="text" class="next-input" name="email_log_channel" id="email_log_channel"
                                       ...
                                       placeholder="{{ trans('core/setting::setting.email.log_channel') }}">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="text-title-field"
                                   for="email_from_name">{{ trans('core/setting::setting.email.sender_name') }}</label>
                        ...
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="email_from_address">{{ trans('core/setting::setting.email.sender_email') }}</label>
                        ...
                        <div class="form-group">
                            ...
                            <label>
                                <input type="checkbox" class="hrv-checkbox" value="1"
                                       @if (setting('using_queue_to_send_mail')) checked
                        ...
                        <div class="form-group">
                            <button class="btn btn-info" type="button" data-target="#send-test-email-modal"
                                    data-toggle="modal">{{ trans('core/setting::setting.test_send_mail') }}</button>
                        </div>
