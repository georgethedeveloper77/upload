                    ...
                    <div class="form-group">
                        ...
                        <label>
                            <input type="checkbox" class="hrv-checkbox" value="1"
                                   ...
                                   @endif name="enable_send_error_reporting_via_email">
                        ...
                        <div class="ui-select-wrapper">
                            <select name="default_admin_theme" class="ui-select" id="default_admin_theme">
                                @foreach(Assets::getThemes() as $theme => $path)
                                    <option value="{{ $theme }}"
                                            @if (setting('default_admin_theme', config('core.base.general.default-theme')) === $theme) selected @endif>
                                        {{ Str::studly($theme) }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    ...
                    <div class="form-group">
                        ...
                        <label class="hrv-label">
                            <input type="radio" name="enable_cache" class="hrv-radio" value="1"
                                   @if (setting('enable_cache')) checked @endif>
                            {{ trans('core/setting::setting.general.yes') }}
                        </label>
                        <label class="hrv-label">
                            <input type="radio" name="enable_cache" class="hrv-radio" value="0"
                                   @if (!setting('enable_cache')) checked @endif>
                    ...
                    <div class="form-group">
                        ...
                        <label class="hrv-label">
                            <input type="radio" name="cache_admin_menu_enable" class="hrv-radio" value="1"
                                   @if (setting('cache_admin_menu_enable')) checked @endif>
                            {{ trans('core/setting::setting.general.yes') }}
                        </label>
                        <label class="hrv-label">
                            <input type="radio" name="cache_admin_menu_enable" class="hrv-radio" value="0"
                                   @if (!setting('cache_admin_menu_enable')) checked @endif>
                            {{ trans('core/setting::setting.general.no') }}
                        </label>
                    </div>
