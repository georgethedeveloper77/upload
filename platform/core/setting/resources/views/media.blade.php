        ...
        <div class="flexbox-annotated-section">
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    <div class="form-group">
                        ...
                        <div class="ui-select-wrapper">
                            <select name="media_driver" class="ui-select setting-select-options" id="media_driver">
                                <option value="public" @if (config('filesystems.default') === 'public') selected @endif>
                                    Local disk
                                </option>
                                <option value="s3" @if (config('filesystems.default') === 's3') selected @endif>Amazon
                                    S3
                                </option>
                                <option value="do_spaces"
                                        @if (config('filesystems.default') === 'do_spaces') selected @endif>DigitalOcean
                                    Spaces
                                </option>
                            </select>
                    ...
                    <div data-type="s3"
                         class="setting-wrapper @if (setting('media_driver', config('filesystems.default')) !== 's3') hidden @endif">
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="media_aws_access_key_id">{{ trans('core/setting::setting.media.aws_access_key_id') }}</label>
                            <input type="text" class="next-input" name="media_aws_access_key_id"
                                   id="media_aws_access_key_id"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="next-input" name="media_aws_default_region"
                                   id="media_aws_default_region"
                    ...
                    <div data-type="do_spaces"
                         class="setting-wrapper @if (setting('media_driver', config('filesystems.default')) !== 'do_spaces') hidden @endif">
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="media_do_spaces_access_key_id">{{ trans('core/setting::setting.media.do_spaces_access_key_id') }}</label>
                            <input type="text" class="next-input" name="media_do_spaces_access_key_id"
                                   id="media_do_spaces_access_key_id"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="next-input" name="media_do_spaces_secret_key"
                                   id="media_do_spaces_secret_key"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="next-input" name="media_do_spaces_default_region"
                                   id="media_do_spaces_default_region"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="next-input" name="media_do_spaces_bucket"
                                   id="media_do_spaces_bucket"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="next-input" name="media_do_spaces_endpoint"
                                   id="media_do_spaces_endpoint"
                        ...
                        <div class="form-group">
                            ...
                            <label>
                                <input type="checkbox" class="hrv-checkbox" value="1"
                                       @if (setting('media_do_spaces_cdn_enabled')) checked
                                       @endif name="media_do_spaces_cdn_enabled">
                        ...
                        <div class="form-group" style="margin-bottom: 1rem;">
                            ...
                            <input type="text" class="next-input" name="media_do_spaces_cdn_custom_domain"
                                   id="media_do_spaces_cdn_custom_domain"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="next-input" name="media_chunk_size" id="media_chunk_size"
                               value="{{ setting('media_chunk_size', config('core.media.media.chunk.chunk_size')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="next-input" name="media_max_file_size" id="media_max_file_size"
                               value="{{ setting('media_max_file_size', config('core.media.media.chunk.max_file_size')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="next-input" name="media_watermark_size" id="media_watermark_size"
                               value="{{ setting('media_watermark_size', config('core.media.media.watermark.size')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="next-input" name="watermark_opacity" id="watermark_opacity"
                               value="{{ setting('watermark_opacity', config('core.media.media.watermark.opacity')) }}"
                               placeholder="{{ trans('core/setting::setting.media.watermark_opacity_placeholder') }}">
                    </div>

                    <div class="form-group">
                        <label class="text-title-field"
                               for="media_watermark_position">{{ trans('core/setting::setting.media.watermark_position') }}</label>
                        <div class="ui-select-wrapper">
                            <select name="media_watermark_position" class="ui-select" id="media_watermark_position">
                                <option value="top-left"
                                        @if (setting('media_watermark_position', config('core.media.media.watermark.position')) == 'top-left' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_top_left') }}</option>
                                <option value="top-right"
                                        @if (setting('media_watermark_position', config('core.media.media.watermark.position')) == 'top-right' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_top_right') }}</option>
                                <option value="bottom-left"
                                        @if (setting('media_watermark_position', config('core.media.media.watermark.position')) == 'bottom-left' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_bottom_left') }}</option>
                                <option value="bottom-right"
                                        @if (setting('media_watermark_position', config('core.media.media.watermark.position')) == 'bottom-right' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_bottom_right') }}</option>
                                <option value="center"
                                        @if (setting('media_watermark_position', config('core.media.media.watermark.position')) == 'center' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_center') }}</option>
                            </select>
                            <svg class="svg-next-icon svg-next-icon-size-16">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                            </svg>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="next-input" name="watermark_position_x" id="watermark_position_x"
                               value="{{ setting('watermark_position_x', config('core.media.media.watermark.x')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="next-input" name="watermark_position_y" id="watermark_position_y"
                               value="{{ setting('watermark_position_y', config('core.media.media.watermark.y')) }}"
