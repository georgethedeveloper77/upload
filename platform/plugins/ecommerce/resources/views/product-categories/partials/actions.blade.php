<a href="{{ route('product-categories.edit', $item->id) }}" class="btn btn-icon btn-primary" data-toggle="tooltip"
...
@if (!$item->is_default)
    <a href="#" class="btn btn-icon btn-danger deleteDialog" data-toggle="tooltip"
       data-section="{{ route('product-categories.destroy', $item->id) }}" role="button"
