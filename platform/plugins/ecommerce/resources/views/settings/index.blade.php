                ...
                <div class="wrapper-content pd-all-20">
                    <div class="form-group">
                        <label class="text-title-field"
                               for="store_name">{{ trans('plugins/ecommerce::store-locator.shop_name') }}</label>
                        <input type="text" class="next-input" name="store_name" id="store_name"
                               value="{{ get_ecommerce_setting('store_name') }}">
                    </div>
                    <div class="form-group">
                        <label class="text-title-field"
                               for="store_phone">{{ trans('plugins/ecommerce::store-locator.phone') }}</label>
                        <input type="text" class="next-input" name="store_phone" id="store_phone"
                               value="{{ get_ecommerce_setting('store_phone') }}">
                    </div>
                    <div class="form-group">
                        <label class="text-title-field"
                               for="store_address">{{ trans('plugins/ecommerce::store-locator.address') }}</label>
                        <input type="text" class="next-input" name="store_address" id="store_address"
                               value="{{ get_ecommerce_setting('store_address') }}">
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label class="text-title-field"
                                   for="store_state">{{ trans('plugins/ecommerce::ecommerce.setting.state') }}</label>
                            <input type="text" class="next-input" name="store_state" id="store_state"
                                   value="{{ get_ecommerce_setting('store_state') }}">
                        </div>
                        <div class="col-sm-6">
                            <label class="text-title-field"
                                   for="store_city">{{ trans('plugins/ecommerce::ecommerce.setting.city') }}</label>
                            <input type="text" class="next-input" name="store_city" id="store_city"
                                   value="{{ get_ecommerce_setting('store_city') }}">
                        </div>
                    </div>
                    <div class="form-group mb0">
                        <label class="text-title-field"
                               for="store_country">{{ trans('plugins/ecommerce::ecommerce.setting.country') }}</label>
                            ...
                            <select name="store_country" class="ui-select" id="store_country">
                                @foreach(['' => trans('plugins/ecommerce::ecommerce.setting.select_country')] + \Botble\Base\Supports\Helper::countries() as $countryCode => $countryName)
                                    <option value="{{ $countryCode }}"
                                            @if (get_ecommerce_setting('store_country') == $countryCode) selected @endif>{{ $countryName }}</option>
                                @endforeach
                            </select>
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label class="text-title-field"
                                   for="store_order_prefix">{{ trans('plugins/ecommerce::ecommerce.start_with') }}</label>
                            <div class="next-input--stylized">
                                <span class="next-input-add-on next-input__add-on--before">#</span>
                                <input type="text" class="next-input next-input--invisible" name="store_order_prefix"
                        ...
                        <div class="col-sm-6">
                            <label class="text-title-field"
                                   for="store_order_suffix">{{ trans('plugins/ecommerce::ecommerce.end_with') }}</label>
                            <input type="text" class="next-input" name="store_order_suffix" id="store_order_suffix"
                    ...
                    <div class="form-group">
                        <p class="setting-note mb0">{{ trans('plugins/ecommerce::ecommerce.order_will_be_shown') }}
                            <span class="sample-order-code">#<span
                                    ...
                                    class="sample-order-code-suffix">{{ get_ecommerce_setting('store_order_suffix') ? '-' . get_ecommerce_setting('store_order_suffix') : '' }}</span></span>
                        </p>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label class="text-title-field"
                                   for="store_weight_unit">{{ trans('plugins/ecommerce::ecommerce.weight_unit') }}</label>
                            <div class="ui-select-wrapper">
                                <select class="ui-select" name="store_weight_unit" id="store_weight_unit">
                                    <option value="g"
                                            @if (get_ecommerce_setting('store_weight_unit', 'g') === 'g') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.weight_unit_gram') }}</option>
                                    <option value="kg"
                                            @if (get_ecommerce_setting('store_weight_unit', 'g') === 'kg') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.weight_unit_kilogram') }}</option>
                                </select>
                                <svg class="svg-next-icon svg-next-icon-size-16">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                                </svg>
                        ...
                        <div class="col-sm-6">
                            <label class="text-title-field"
                                   for="store_width_height_unit">{{ trans('plugins/ecommerce::ecommerce.height_unit') }}</label>
                            <div class="ui-select-wrapper">
                                <select class="ui-select" name="store_width_height_unit" id="store_width_height_unit">
                                    <option value="cm"
                                            @if (get_ecommerce_setting('store_width_height_unit', 'cm') === 'cm') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.height_unit_cm') }}</option>
                                    <option value="m"
                                            @if (get_ecommerce_setting('store_width_height_unit', 'cm') === 'm') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.height_unit_m') }}</option>
                                </select>
                                <svg class="svg-next-icon svg-next-icon-size-16">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                                </svg>
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label class="text-title-field"
                                   for="thousands_separator">{{ trans('plugins/ecommerce::ecommerce.setting.thousands_separator') }}</label>
                            <div class="ui-select-wrapper">
                                <select class="ui-select" name="thousands_separator" id="thousands_separator">
                                    <option value=","
                                            @if (get_ecommerce_setting('thousands_separator', ',') == ',') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.separator_comma') }}</option>
                                    <option value="."
                                            @if (get_ecommerce_setting('thousands_separator', ',') == '.') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.separator_period') }}</option>
                                    <option value=" "
                                            @if (get_ecommerce_setting('thousands_separator', ',') == ' ') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.separator_space') }}</option>
                                </select>
                                <svg class="svg-next-icon svg-next-icon-size-16">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                                </svg>
                        ...
                        <div class="col-sm-6">
                            <label class="text-title-field"
                                   for="decimal_separator">{{ trans('plugins/ecommerce::ecommerce.setting.decimal_separator') }}</label>
                            <div class="ui-select-wrapper">
                                <select class="ui-select" name="decimal_separator" id="decimal_separator">
                                    <option value="."
                                            @if (get_ecommerce_setting('decimal_separator', '.') == '.') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.separator_period') }}</option>
                                    <option value=","
                                            @if (get_ecommerce_setting('decimal_separator', '.') == ',') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.separator_comma') }}</option>
                                    <option value=" "
                                            @if (get_ecommerce_setting('decimal_separator', '.') == ' ') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.separator_space') }}</option>
                                </select>
                                <svg class="svg-next-icon svg-next-icon-size-16">
                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                                </svg>
        ...
        <div class="flexbox-annotated-section store-locator-wrap">
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if (!$storeLocator->is_primary && $storeLocators->count() > 1)
                                        <button class="btn btn-danger btn-small btn-trigger-delete-store-locator"
                    ...
                    <a href="#" class="btn btn-primary btn-trigger-show-store-locator" data-type="create"
                    ...
                    @if (count($storeLocators) > 0)
                        <p style="margin-top: 10px">{{ trans('plugins/ecommerce::ecommerce.setting.or') }} <a href="#"
                                                                                                              data-toggle="modal"
                                                                                                              data-target="#change-primary-store-locator-modal">{{ trans('plugins/ecommerce::ecommerce.setting.change_primary_store') }}</a>
                        </p>
                    @endif
                </div>
            </div>
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    ...
                    <div class="form-group">
                        ...
                        <div class="ui-select-wrapper">
                            <select name="quick_buy_target_page" class="ui-select form-control select-full"
                                    id="quick_buy_target_page">
                                <option value="checkout"
                                        @if (EcommerceHelper::getQuickBuyButtonTarget() == 'checkout') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.checkout_page') }}</option>
                                <option value="cart"
                                        @if (EcommerceHelper::getQuickBuyButtonTarget() == 'cart') selected @endif>{{ trans('plugins/ecommerce::ecommerce.setting.cart_page') }}</option>
                            </select>
                            <svg class="svg-next-icon svg-next-icon-size-16">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                            </svg>
                    ...
                    <div class="form-group">
                        ...
                        <label><input type="checkbox" class="check-all"
                                      data-set=".available-countries">{{ trans('plugins/ecommerce::ecommerce.setting.all') }}
                        </label>
        ...
        <div class="flexbox-annotated-section" style="border: none">
            ...
            <div class="flexbox-annotated-section-content">
                <button class="btn btn-info"
                        type="submit">{{ trans('plugins/ecommerce::currency.save_settings') }}</button>
            </div>
        </div>
    </div>
    {!! Form::close() !!}
            ...
            <div class="swatch-item swatch-is-prefix-symbol" data-type="is_prefix_symbol">
                <div class="ui-select-wrapper">
                    <select class="ui-select">
                        <option value="1"
                                __isPrefixSymbolChecked__>{{ trans('plugins/ecommerce::currency.before_number') }}</option>
                        <option value="0"
                                __notIsPrefixSymbolChecked__>{{ trans('plugins/ecommerce::currency.after_number') }}</option>
                    </select>
                    <svg class="svg-next-icon svg-next-icon-size-16">
                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                    </svg>
