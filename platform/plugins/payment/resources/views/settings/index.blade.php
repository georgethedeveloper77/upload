    ...
    <div class="container">
        <div class="row">
            <div class="group flexbox-annotated-section">
                ...
                <div class="col-md-9">
                    @php use Botble\Payment\Models\Payment;do_action(BASE_ACTION_META_BOXES, 'top', new Payment) @endphp

                    <div class="wrapper-content pd-all-20">
                        {!! Form::open(['route' => 'payments.settings']) !!}
                        <div class="form-group">
                            <label
                                for="default_payment_method">{{ trans('plugins/payment::payment.default_payment_method') }}</label>
                        ...
                        <button type="button"
                                class="btn btn-info button-save-payment-settings">{{ trans('core/base::forms.save') }}</button>
                        {!! Form::close() !!}
                    </div>
                        ...
                        <tr class="border-pay-row">
                            ...
                            <td style="width: 20%;">
                                <img class="filter-black"
                                     src="{{ url('vendor/core/plugins/payment/images/stripe.svg') }}">
                            </td>
                                        ...
                                        <div class="well bg-white">
                                            <div class="form-group">
                                                <label class="text-title-field"
                                                       for="stripe_name">{{ trans('plugins/payment::payment.method_name') }}</label>
                                                <input type="text" class="next-input input-name"
                                                       name="payment_stripe_name" id="stripe_name" data-counter="400"
                                                       value="{{ setting('payment_stripe_name', trans('plugins/payment::payment.pay_online_via', ['name' => 'Stripe'])) }}">
                                            </div>
                                            <div class="form-group">
                                                <label class="text-title-field"
                                                       for="payment_stripe_description">{{ __('Description') }}</label>
                                                <textarea class="next-input" name="payment_stripe_description"
                                                          id="payment_stripe_description">{{ get_payment_setting('description', 'stripe', __('Payment with Stripe')) }}</textarea>
                                            </div>
                                            <p class="payment-note">
                                                {{ trans('plugins/payment::payment.please_provide_information') }} <a
                                                    target="_blank" href="//www.stripe.com">Stripe</a>:
                                            </p>
                                            <div class="form-group">
                                                <label class="text-title-field"
                                                       for="stripe_client_id">{{ trans('plugins/payment::payment.stripe_key') }}</label>
                                                <input type="text" class="next-input" name="payment_stripe_client_id"
                                                       id="stripe_client_id"
                                                       value="{{ app()->environment('demo') ? '*******************************' : setting('payment_stripe_client_id') }}">
                                            </div>
                                            <div class="form-group">
                                                <label class="text-title-field"
                                                       for="stripe_secret">{{ trans('plugins/payment::payment.stripe_secret') }}</label>
                    ...
                    <table class="table payment-method-item">
                        ...
                        <tr class="border-pay-row">
                            ...
                            <td style="width: 20%;">
                                <img class="filter-black"
                                     src="{{ url('vendor/core/plugins/payment/images/ppcom.svg') }}" alt="PayPal">
                            </td>
                            <td class="border-right">
                                <ul>
                                    <li>
                                ...
                                <div class="float-left" style="margin-top: 5px;">
                                    <div class="payment-name-label-group  @if ($payPalStatus== 0) hidden @endif">
                                        <span
                                            class="payment-note v-a-t">{{ trans('plugins/payment::payment.use') }}:</span>
                                        <label
                                            class="ws-nm inline-display method-name-label">{{ setting('payment_paypal_name') }}</label>
                                    </div>
                                </div>
                                <div class="float-right">
                        ...
                        <tr class="paypal-online-payment payment-content-item hidden">
                            <td class="border-left" colspan="3">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <ul>
                                            ...
                                            <li class="payment-note">
                                                <p>{{ trans('plugins/payment::payment.configuration_requirement', ['name' => 'PayPal']) }}
                                                    :</p>
                                                <ul class="m-md-l" style="list-style-type:decimal">
                                                    <li style="list-style-type:decimal">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="well bg-white">
                                            <div class="form-group">
                                                <label class="text-title-field"
                                                       for="paypal_name">{{ trans('plugins/payment::payment.method_name') }}</label>
                                                <input type="text" class="next-input input-name"
                                                       name="payment_paypal_name" id="paypal_name" data-counter="400"
                                                       value="{{ setting('payment_paypal_name', trans('plugins/payment::payment.pay_online_via', ['name' => 'PayPal'])) }}">
                                            </div>
                                            <div class="form-group">
                                                <label class="text-title-field"
                                                       for="payment_paypal_description">{{ __('Description') }}</label>
                                                <textarea class="next-input" name="payment_paypal_description"
                                                          id="payment_paypal_description">{{ get_payment_setting('description', 'paypal', __('Payment with PayPal')) }}</textarea>
                                            </div>
                                            <p class="payment-note">
                                                {{ trans('plugins/payment::payment.please_provide_information') }} <a
                                                    target="_blank" href="//www.paypal.com">PayPal</a>:
                                            </p>
                                            <div class="form-group">
                                                <label class="text-title-field"
                                                       for="paypal_client_id">{{ trans('plugins/payment::payment.client_id') }}</label>
                                                <input type="text" class="next-input" name="payment_paypal_client_id"
                                                       id="paypal_client_id"
                                                       value="{{ app()->environment('demo') ? '*******************************' :setting('payment_paypal_client_id') }}">
                                            </div>
                                            <div class="form-group">
                                                <label class="text-title-field"
                                                       for="paypal_client_secret">{{ trans('plugins/payment::payment.client_secret') }}</label>
                                                <div class="input-option">
                                                    <input type="password" class="next-input" placeholder="••••••••"
                                                           id="paypal_client_secret" name="payment_paypal_client_secret"
                                            ...
                                            <div class="form-group">
                                                <label class="next-label">
                                                    <input type="checkbox" class="hrv-checkbox" value="0"
                                                           ...
                                                           @if (setting('payment_paypal_mode') == 0) checked @endif>
                                ...
                                <div class="col-12 bg-white text-right">
                                    <button
                                        class="btn btn-warning disable-payment-item @if ($payPalStatus == 0) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.deactivate') }}</button>
                                    <button
                                        class="btn btn-info save-payment-item btn-text-trigger-save @if ($payPalStatus == 1) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.activate') }}</button>
                                    <button
                                        class="btn btn-info save-payment-item btn-text-trigger-update @if ($payPalStatus == 0) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.update') }}</button>
                                </div>
                                {!! Form::close() !!}
                            </td>
                    ...
                    <table class="table payment-method-item">
                            ...
                            <td colspan="3">
                                <div class="float-left" style="margin-top: 5px;">
                                    <div class="payment-name-label-group">
                                        @if ($codStatus != 0)<span class="payment-note v-a-t">{{ trans('plugins/payment::payment.use') }}:</span>@endif
                                        <label
                                            class="ws-nm inline-display method-name-label">{{ setting('payment_cod_name', \Botble\Payment\Enums\PaymentMethodEnum::COD()->label()) }}</label>
                                    </div>
                                </div>
                                <div class="float-right">
                            ...
                            <td class="border-left" colspan="3">
                                ...
                                <div class="col-sm-12">
                                    <div class="well bg-white">
                                        <div class="form-group">
                                            <label class="text-title-field"
                                                   for="payment_cod_name">{{ trans('plugins/payment::payment.method_name') }}</label>
                                            <input type="text" class="next-input" name="payment_cod_name"
                                                   id="payment_cod_name" data-counter="400"
                                                   value="{{ setting('payment_cod_name', \Botble\Payment\Enums\PaymentMethodEnum::COD()->label()) }}">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-title-field"
                                                   for="payment_cod_description">{{ trans('plugins/payment::payment.payment_method_description') }}</label>
                                            <textarea class="next-input" name="payment_cod_description"
                                                      id="payment_cod_description">{{ setting('payment_cod_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 bg-white text-right">
                                    <button
                                        class="btn btn-warning disable-payment-item @if ($codStatus == 0) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.deactivate')  }}</button>
                                    <button
                                        class="btn btn-info save-payment-item btn-text-trigger-save @if ($codStatus == 1) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.activate') }}</button>
                                    <button
                                        class="btn btn-info save-payment-item btn-text-trigger-update @if ($codStatus == 0) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.update') }}</button>
                                </div>
                                {!! Form::close() !!}
                            </td>
                        ...
                        <tr class="bg-white">
                            <td colspan="3">
                                <div class="float-left" style="margin-top: 5px;">
                                    <div class="payment-name-label-group">
                                        @if ($bankTransferStatus != 0) <span class="payment-note v-a-t">{{ trans('plugins/payment::payment.use') }}:</span>@endif
                                        <label
                                            class="ws-nm inline-display method-name-label">{{ setting('payment_bank_transfer_name', \Botble\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER()->label()) }}</label>
                                    </div>
                                </div>
                                <div class="float-right">
                            ...
                            <td class="border-left" colspan="3">
                                ...
                                <div class="col-sm-12">
                                    <div class="well bg-white">
                                        <div class="form-group">
                                            <label class="text-title-field"
                                                   for="payment_bank_transfer_name">{{ trans('plugins/payment::payment.method_name') }}</label>
                                            <input type="text" class="next-input" name="payment_bank_transfer_name"
                                                   id="payment_bank_transfer_name" data-counter="400"
                                                   value="{{ setting('payment_bank_transfer_name', \Botble\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER()->label()) }}">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-title-field"
                                                   for="payment_bank_transfer_description">{{ trans('plugins/payment::payment.payment_method_description') }}</label>
                                            <textarea class="next-input" name="payment_bank_transfer_description"
                                                      id="payment_bank_transfer_description">{{ setting('payment_bank_transfer_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 bg-white text-right">
                                    <button
                                        class="btn btn-warning disable-payment-item @if ($bankTransferStatus == 0) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.deactivate') }}</button>
                                    <button
                                        class="btn btn-info save-payment-item btn-text-trigger-save @if ($bankTransferStatus == 1) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.activate') }}</button>
                                    <button
                                        class="btn btn-info save-payment-item btn-text-trigger-update @if ($bankTransferStatus == 0) hidden @endif"
                                        type="button">{{ trans('plugins/payment::payment.update') }}</button>
                                </div>
                                {!! Form::close() !!}
                            </td>
            ...
            @php use Botble\Payment\Models\Payment;do_action(BASE_ACTION_META_BOXES, 'main', new Payment) @endphp
            <div class="group">
                <div class="col-md-3">

                </div>
                <div class="col-md-9">
                    @php use Botble\Payment\Models\Payment;do_action(BASE_ACTION_META_BOXES, 'advanced', new Payment) @endphp
                </div>
            </div>
        </div>
    </div>
