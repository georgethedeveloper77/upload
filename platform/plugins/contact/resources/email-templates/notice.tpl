                            ...
                            <tr>
                                <td align="left" style="padding: 20px 50px;">
                                    ...
                                    <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/edit.png"
                                            alt="Subject" width="20" style="margin-right: 10px;"/> {{ contact_subject }}
                                    </p>
                                    ...
                                    <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/message.png"
                                            alt="Message" width="20" style="margin-right: 10px;"/> {{ contact_content }}
                                    </p>
                                </td>
                            </tr>
                            </tbody>
                ...
                <tr>
                    <td class="column" align="center">
                        <table>
                            ...
                            <tr>
                                <td align="center">
                                    <p>You can reply an email to {{ contact_email }} by clicking on below button.</p>
                                    <br/>
