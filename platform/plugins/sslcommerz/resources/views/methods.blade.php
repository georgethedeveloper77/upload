@if (get_payment_setting('status', SSLCOMMERZ_PAYMENT_METHOD_NAME) == 1)
    <li class="list-group-item">
        <input class="magic-radio js_payment_method" type="radio" name="payment_method"
               ...
               value="{{ SSLCOMMERZ_PAYMENT_METHOD_NAME }}" data-toggle="collapse"
               data-target=".payment_{{ SSLCOMMERZ_PAYMENT_METHOD_NAME }}_wrap"
        ...
        <div
            class="payment_{{ SSLCOMMERZ_PAYMENT_METHOD_NAME }}_wrap payment_collapse_wrap collapse @if (setting('default_payment_method') == SSLCOMMERZ_PAYMENT_METHOD_NAME) show @endif">
